    ...
    <AppLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-xs text-white/40 mt-0.5">¿Qué pasaría si compras esto a MSI?</p>
        </div>
        ...
        <div className="bg-[#141414] rounded-2xl border border-white/[0.06] p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="col-span-2">
              <label className="block text-xs text-white/50 mb-1">¿Qué quieres comprar?</label>
              <input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))} onFocus={reset}
                className="w-full bg-[#0A0A0A] border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-[#4F8EF7]" placeholder="Ej. Sony WH-1000XM6, PS5, sillón…" />
            </div>
            <div>
              <label className="block text-xs text-white/50 mb-1">Precio total</label>
            ...
            <div>
              <label className="block text-xs text-white/50 mb-1">Número de meses</label>
          ...
          <>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-[#141414] rounded-xl p-4 border border-white/[0.06]">
                ...
                <p className="text-xs text-white/30 mt-1">{worstMonth?.label}</p>
              </div>
            </div>
